...
juntaTiles p = Pictures (repeatTiles (l/2) p)
----------------------------------------------------------------------------------------------------------------------------
...
main :: IO()
main = do
    botaoP <- loadBMP "Botoes/Pausa.bmp" 
    botaoJA <- loadBMP "Botoes/BotaoJogar_Ativo.bmp" 
    botaoJ <- loadBMP "Botoes/BotaoJogar.bmp" 
    botaoMA <- loadBMP "Botoes/BotaoMenu_Ativo.bmp" 
    botaoM <- loadBMP "Botoes/BotaoMenu.bmp" 
    botaoOA <- loadBMP "Botoes/BotaoOpcoes_Ativo.bmp" 
    botaoO <- loadBMP "Botoes/BotaoOpcoes.bmp" 
    botaoRA <- loadBMP "Botoes/BotaoReiniciar_Ativo.bmp" 
    botaoR <- loadBMP "Botoes/BotaoReiniciar.bmp" 
    botaoSA <- loadBMP "Botoes/BotaoSkins_Ativo.bmp" 
    botaoS <- loadBMP "Botoes/BotaoSkins.bmp" 
    botaoVA <- loadBMP "Botoes/BotaoVoltar_Ativo.bmp" 
    botaoV <- loadBMP "Botoes/BotaoVoltar.bmp"
    setaDour <- loadBMP "Botoes/SetaDourada.bmp"
    setaVerm <- loadBMP "Botoes/SetaVermelha.bmp"
    botaoEasy <- loadBMP "Botoes/BotaoFacil.bmp"
    botaoMedium <- loadBMP "Botoes/BotaoMedio.bmp"
    botaoHard <- loadBMP "Botoes/BotaoDificil.bmp"
    botaoSun <- loadBMP "Botoes/Sol.bmp"
    botaoMoon <- loadBMP "Botoes/Lua.bmp"
    ...
    fundoL <- loadBMP "Fundos/Fundo_LightMode.bmp" 
    fundoD <- loadBMP "Fundos/Fundo_DarkMode.bmp" 
    logotipo <- loadBMP "Fundos/Logo_CrossyRoad.bmp" 
    gameOv <- loadBMP "Fundos/GameOver.bmp"
    highSc <- loadBMP "Fundos/HighScore.bmp"
    sc <- loadBMP "Fundos/Score.bmp"
    ...
    fotoMapaClassico <- loadBMP "FotosMapas/FotoMapaClassico.bmp" 
    fotoMapaNatal <- loadBMP "FotosMapas/FotoMapaNatal.bmp" 
    fotoMapaDetalhado <- loadBMP "FotosMapas/FotoMapaDetalhado.bmp" 
    fotoMapaMinecraft <- loadBMP "FotosMapas/FotoMapaMinecraft.bmp" 

    rioClassico <- loadBMP "Mapas/MapaClassico/MapaClassico_Rio.bmp"
    estradaClassico <- loadBMP "Mapas/MapaClassico/MapaClassico_Estrada.bmp"
    relvaClassico <- loadBMP "Mapas/MapaClassico/MapaClassico_Relva.bmp"
    troncoClassico <- loadBMP "Mapas/MapaClassico/MapaClassico_Tronco.bmp"
    carroDireitaClassico <- loadBMP "Mapas/MapaClassico/MapaClassico_Carro_Direita.bmp"
    carroEsquerdaClassico <- loadBMP "Mapas/MapaClassico/MapaClassico_Carro_Esquerda.bmp"
    arvoreClas <- loadBMP "Mapas/MapaClassico/MapaClassico_Arvore.bmp"

    let arvoreClassico = Scale (1.2) (1.1) arvoreClas
    
    rioDetalhado <- loadBMP "Mapas/MapaDetalhado/MapaDetalhado_Rio.bmp"
    estradaDetalhado <- loadBMP "Mapas/MapaDetalhado/MapaDetalhado_Estrada.bmp"
    relvaDetalhado <- loadBMP "Mapas/MapaDetalhado/MapaDetalhado_Relva.bmp"
    troncoDetalhado <- loadBMP "Mapas/MapaDetalhado/MapaDetalhado_Tronco.bmp"
    carroDireitaDetalhado <- loadBMP "Mapas/MapaDetalhado/MapaDetalhado_Carro_Direita.bmp"
    carroEsquerdaDetalhado <- loadBMP "Mapas/MapaDetalhado/MapaDetalhado_Carro_Esquerda.bmp"
    arvoreDetalhado <- loadBMP "Mapas/MapaDetalhado/MapaDetalhado_Arvore.bmp"    

    rioMine <- loadBMP "Mapas/MapaMinecraft/MapaMinecraft_Rio.bmp"
    estradaMine <- loadBMP "Mapas/MapaMinecraft/MapaMinecraft_Estrada.bmp"
    relvaMine <- loadBMP "Mapas/MapaMinecraft/MapaMinecraft_Relva.bmp"
    troncoMine <- loadBMP "Mapas/MapaMinecraft/MapaMinecraft_Tronco.bmp"
    carroDireitaMinecraft <- loadBMP "Mapas/MapaMinecraft/MapaMinecraft_Carro_Direita.bmp"
    carroEsquerdaMinecraft <- loadBMP "Mapas/MapaMinecraft/MapaMinecraft_Carro_Esquerda.bmp"
    arvoreMine <- loadBMP "Mapas/MapaMinecraft/MapaMinecraft_Arvore.bmp"
    ...
    rioNatal <- loadBMP "Mapas/MapaNatal/MapaNatal_Rio.bmp"
    estradaNatal <- loadBMP "Mapas/MapaNatal/MapaNatal_Estrada.bmp"
    relvaNatal <- loadBMP "Mapas/MapaNatal/MapaNatal_Relva.bmp"
    troncoNatal <- loadBMP "Mapas/MapaNatal/MapaNatal_Tronco.bmp"
    carroDireitaNatal <- loadBMP "Mapas/MapaNatal/MapaNatal_Carro_Direita.bmp"
    carroEsquerdaNatal <- loadBMP "Mapas/MapaNatal/MapaNatal_Carro_Esquerda.bmp"
    arvoreNatal <- loadBMP "Mapas/MapaNatal/MapaNatal_Arvore.bmp"
    ...
    numeroSei <- loadBMP "Numeros/Seis.bmp"
    numeroSet <- loadBMP "Numeros/Sete.bmp"
    numeroO <- loadBMP "Numeros/Oito.bmp"
    numeroN <- loadBMP "Numeros/Nove.bmp"
    ...
    skinAmongUsDi <- loadBMP "Skins/SkinAmongUs/AmongUsDireita.bmp"
    skinAmongUsEs <- loadBMP "Skins/SkinAmongUs/AmongUsEsquerda.bmp"
    ...
    skinGalinhaCima <- loadBMP "Skins/SkinGalinha/GalinhaCima.bmp"
    skinGalinhaBaixo <- loadBMP "Skins/SkinGalinha/GalinhaBaixo.bmp"
    skinGalinhaEsquerda <- loadBMP "Skins/SkinGalinha/GalinhaEsquerda.bmp"
    skinGalinhaDireita <- loadBMP "Skins/SkinGalinha/GalinhaDireita.bmp"
    
    skinGalinhaNatalCima <- loadBMP "Skins/SkinGalinhaNatal/GalinhaCimaNatal.bmp"
    skinGalinhaNatalBaixo <- loadBMP "Skins/SkinGalinhaNatal/GalinhaBaixoNatal.bmp"
    skinGalinhaNatalEsquerda <- loadBMP "Skins/SkinGalinhaNatal/GalinhaEsquerdaNatal.bmp"
    skinGalinhaNatalDireita <- loadBMP "Skins/SkinGalinhaNatal/GalinhaDireitaNatal.bmp"
    
    skinMarioDi <- loadBMP "Skins/SkinMario/MarioDireita.bmp"
    skinMarioEs <- loadBMP "Skins/SkinMario/MarioEsquerda.bmp"
    ...
    skinPacManCima <- loadBMP "Skins/SkinPacMan/PacManCima.bmp"
    skinPacManBaixo <- loadBMP "Skins/SkinPacMan/PacManBaixo.bmp"
    skinPacManEsquerda <- loadBMP "Skins/SkinPacMan/PacManEsquerda.bmp"
    skinPacManDireita <- loadBMP "Skins/SkinPacMan/PacManDireita.bmp"
    
    skinSteveCi <- loadBMP "Skins/SkinSteve/SteveCima.bmp"
    skinSteveBa <- loadBMP "Skins/SkinSteve/SteveBaixo.bmp"
    skinSteveEs <- loadBMP "Skins/SkinSteve/SteveEsquerda.bmp"
    skinSteveDi <- loadBMP "Skins/SkinSteve/SteveDireita.bmp"
